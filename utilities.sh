...
&& curl -Lf -o /tmp/wkhtmltox_bookworm_amd64.deb  https://github.com/wkhtmltopdf/packaging/releases/download/0.12.6.1-3/wkhtmltox_0.12.6.1-3.bookworm_amd64.deb \
&& cd /opt/ \
&& minimal_apt_get_install /tmp/wkhtmltox_bookworm_amd64.deb
