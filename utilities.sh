...
run minimal_apt_get_install postgresql-client-10 
run minimal_apt_get_install nodejs npm
...
run cd /opt/
run minimal_apt_get_install /tmp/wkhtmltox_0.12.6-1.bionic_amd64.deb 
